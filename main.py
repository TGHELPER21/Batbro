    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "visionias" in url:
              ...
              headers = {
                'Host': 'as-multiverse-3eec9f18a633.herokuapp.com',
                'x-access-token': raw_text_tok,
              ...
              params = (('url', f'{url}'),)
              response = requests.get('https://as-multiverse-3eec9f18a633.herokuapp.com/get_keys?link=', headers=headers, params=params)
              url = response.json()['url']
